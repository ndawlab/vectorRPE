classdef PoissonStimulusTrain < handle
  ...
  methods
    ...
    %----- Constructor
    function obj = PoissonStimulusTrain(targetNTrials, trialDuplication, trialDispersion)
    ...
    function modified = configure(obj, lCue, cueVisAt, cueDensityPerM, cueMeanRatio, maxNumCues, cueMinSeparation, numPanSession)
