...
%
function [velocity] = moveArduino_FAKE(vr, PosFromData) %took out rawData
...
if dT == 0
    ...
    velocity(2)     = vr.scaleY * dY / dT; %rachel: velocity is still too big... figure out scalex, scaleY...
    ...
    if isnan(vr.scaleA)
      ...
      velocity(4)   = 0; % always zero for now  (vr.orientation - heading);
