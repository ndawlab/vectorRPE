...
if ~exist('tmp_cue_kernels_4cues_ConfDiscmNoNeutral_ConIps_z.mat','file')
    ...
    save tmp_cue_kernels_4cues_ConfDiscmNoNeutral_ConIps_z %% CHANGE THIS TO INTERIM SAVE/DATA SAVE! 
else
    load tmp_cue_kernels_4cues_ConfDiscmNoNeutral_ConIps_z
end
% the scale is incorrect. it fits what i see when neutral is folded in. 
% first run on iMac; it has the 3 versions. check that they work out right
