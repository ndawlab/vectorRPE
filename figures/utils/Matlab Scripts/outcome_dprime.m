...
res_diff = rpe_analysis_thirds(res_cell_ac_sfn,0);
res_currw = rpe_analysis_thirds(res_cell_ac_sfn,1);


load vars_sig_all sig_all % code for this can be found in the first section of neural_behaviors.m

sig_all_rw = sig_all(:,end); % get all units 

% load dprime_thirds res_diff res_currw sig_all_rw

% load dprime_thirds  sig_all_rw
